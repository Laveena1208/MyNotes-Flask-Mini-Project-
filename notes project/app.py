...
import uuid #--->random string generate karke dega
from datetime import date, datetime, timedelta
from functools import wraps
from flask import Flask, render_template,request, redirect, flash,session, make_response
from flask.helpers import url_for
from flask_sqlalchemy import SQLAlchemy
# from sqlalchemy.orm import session ---> YEH VSC DEHTA H BUT WE DONT WANT
...
# ORM -->OBJECT relation MODEL EK MIDDLE WARE THE FLASK AND DATABASE MEI
